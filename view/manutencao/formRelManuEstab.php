    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">Relatório de Manutenções por Estabelecimento</div>

                <div class="panel-body">

                    <form action="../../control/manutencao/relatorioManutEstab.php" method="post">
		                <div class="row">
		                    ...
		                    <div class="col-md-3">
		                        <div class="form-group">
		                            ...
		                            <select class="dropdown form-control" name="status_manutencao">
