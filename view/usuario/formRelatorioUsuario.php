    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">Opções de Relatórios de Usuários</div>
						...
						<div class="row">
		                    ...
		                    <div class="col-md-2 col-md-offset-1">
		                        <div class="form-group">
		                            <label><a href="../../control/usuario/relatorioUsuario.php" class="btn btn-info"> Todos</a></label>
		                        </div>
		                    </div>
		
		                    <div class="col-md-2">
		                        <div class="form-group">
		                            <label><a href="#" class="btn btn-info"> Por estabelecimento</a></label>
		                        </div>
		                    </div>  
